...
title: IRDetector-Gbunza
project: IRDetector-Gbunza
author: John Plocher
date: 2017-01
status: released
release: yes
...
layout: arduino
tagline: Quad IR detector with hysteresis for IO4-IR-Detector-GBunza board on SPCoast.com
overview: >
    
    Add LCD display support
    
artifacts:
  - path: /sketches/IRDetector-Gbunza/IRDetector-Gbunza.ino
...
This technical documentation is licensed under the [MIT License](https://opensource.org/licenses/MIT)
