...
title: ExampleSignalStateMachine
project: ExampleSignalStateMachine
author: John Plocher
date: 2018
status: released
release: yes
...
layout: arduino
tagline: Simulate a progression of signal aspects and a grade crossing
overview: >
...
artifacts:
  - path: /sketches/ExampleSignalStateMachine/ExampleSignalStateMachine.ino
    tag: ExampleSignalStateMachine.ino
    type: download
    post: Arduino Sketch
---
