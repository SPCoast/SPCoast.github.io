...
images:
  - image_path: /versions/Core-ESP32/2.3/Core-ESP32.bot.brd.png
    title: Bot Silk
  - image_path: /versions/Core-ESP32/2.3/Core-ESP32.top.brd.png
    title: Top Silk
  - image_path: /versions/Core-ESP32/2.3/Core-ESP32.brd.png
    title: Board
  - image_path: /versions/Core-ESP32/2.3/Core-ESP32.sch.png
    title: Schematic
artifacts:
  - path: /versions/Core-ESP32/2.3/Core-ESP32.dpv
    tag: Core-ESP32
    type: download
    post: CHMT Component and feeder definitions
  - path: /versions/Core-ESP32/2.3/Core-ESP32.gerbers.zip
    tag: Core-ESP32.gerbers.zip
    type: download
    post: Gerber Fabrication files
  - path: /versions/Core-ESP32/2.3/Core-ESP32.parts.csv
