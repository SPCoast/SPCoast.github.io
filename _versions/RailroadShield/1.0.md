...
images:
  - image_path: /versions/RailroadShield/1.0/RailroadShield.brd.png
    title: Board
  - image_path: /versions/RailroadShield/1.0/RailroadShield.sch.png
    title: Schematic
  - image_path: /versions/RailroadShield/1.0/RailroadShield.top.brd.png
    title: Top Silk
  - image_path: /versions/RailroadShield/1.0/RailroadShield.bot.brd.png
    title: Bot Silk
artifacts:
  - path: /versions/RailroadShield/1.0/RailroadShield.dpv
    tag: RailroadShield
    type: download
    post: CHMT Component and feeder definitions
  - path: /versions/RailroadShield/1.0/RailroadShield.gerbers.zip
    tag: RailroadShield.gerbers.zip
    type: download
    post: Gerber Fabrication files
  - path: /versions/RailroadShield/1.0/RailroadShield.parts.csv
