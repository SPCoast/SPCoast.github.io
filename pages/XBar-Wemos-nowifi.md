...
title: XBar-Wemos-nowifi
project: XBar-Wemos-nowifi
author: John Plocher
date: 2016
status: released
release: yes
...
layout: arduino
tagline: Test harness code for I2C extender
overview: >
    
    
artifacts:
  - path: /sketches/XBar-Wemos-nowifi/XBar-Wemos-nowifi.ino
    tag: XBar-Wemos-nowifi.ino
    type: download
    post: Arduino Sketch
---
