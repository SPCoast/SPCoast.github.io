...
title: JohnsOfficePimp
project: JohnsOfficePimp
author: John Plocher
date: 2015
status: released
release: yes
...
layout: arduino
tagline: An addressible WS2801 style RGB LED string fading slowly across the HSB color space - under my desk
overview: >
    
    initial release
artifacts:
  - path: /sketches/JohnsOfficePimp/JohnsOfficePimp.ino
    tag: JohnsOfficePimp.ino
    type: download
    post: Arduino Sketch
---
