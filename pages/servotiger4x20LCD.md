...
title: servotiger4x20LCD
project: servotiger4x20LCD
author: John Plocher
date: 2008
status: released
release: yes
...
layout: arduino
tagline: Make music with servos and a Tiger Xylopiano - uses several servos with wooden hammers
overview: >
    
artifacts:
  - path: /sketches/servotiger4x20LCD/servotiger4x20LCD.ino
    tag: servotiger4x20LCD.ino
    type: download
    post: Arduino Sketch
---
